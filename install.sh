...
echo "  • Global CLI command: forge"
echo "  • Example: forge version"
echo ""
echo "Next step (required for each project):"
echo "  cd your-project"
echo "  forge init"
echo ""
echo "Notes:"
echo "  • /forge-* commands do not appear from global install alone"
echo "  • forge init generates project files for Claude Code"
echo "  • For Cursor/Codex, also run: forge generate --target cursor|codex"
echo ""
